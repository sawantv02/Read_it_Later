...
<script type="text/javascript" src="resources/js/contentManagerIndex.js"></script>
	...
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="#" accesskey="2" title="" id="mylist">My List</a></li>
				<li><a href="#" accesskey="3" title="" id="articles">Articles</a></li>
				...
				<li><a href="#" accesskey="7" title="" id="mymessages">My Messages</a></li>
				<li><a href="signout.htm" accesskey="8" title="" id="signout">Sign Out</a></li>
			</ul>
		</div>
	</div>
	<div id="main">
